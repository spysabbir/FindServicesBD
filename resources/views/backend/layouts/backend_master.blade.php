    ...
    <div id="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown language-menu hidden-xs">
                                ...
                                <div class="dropdown-menu language_widget mt-0">
                                    <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ asset('backend') }}/images/flag/us.svg" alt="US English" > US English</a>
                                    <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ asset('backend') }}/images/flag/gb.svg" alt="UK English" > UK English</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ asset('backend') }}/images/flag/russia.svg" alt="Russian" > Russian</a>
                                    <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ asset('backend') }}/images/flag/arabia.svg" alt="Arabic" > Arabic</a>
                                    <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ asset('backend') }}/images/flag/france.svg" alt="French" > French</a>
                                </div>
                            </li>
        ...
        <div id="left-sidebar" class="sidebar">
            ...
            <div class="navbar-brand">
                <a href="index.html"><img src="{{ asset('backend') }}/images/icon.svg" alt="Mooli Logo" class="img-fluid logo"><span>Mooli</span></a>
